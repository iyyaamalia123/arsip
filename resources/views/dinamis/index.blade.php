            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="#" class="btn btn-sm btn-neutral" data-toggle="modal" data-target="#modal-form">New
                            Folder</a>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-body p-0">
                    <div class="card bg-secondary border-0 mb-0">
                        <div class="card-body px-lg-5 py-lg-5">
                            ...
                            <form role="form" method="POST" action="{{ url('menu/store_folder/' . $id_menu) }}">
                                @csrf
...
@section('js')
    <script>
        ...
        $(document).on('click', '.btn_rename', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#form_rename').attr('action', '/menu/rename_folder/' + id);
                }
            })
        })
        ...
        $('#search_input').keyup(function() {
            ...
            $.ajax({
                url: "/menu/" + menu + "/searching?folder=" + value,
                success: function(data) {
                    $('.main-box').empty();
