                            ...
                            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                        ...
                                        @foreach ($years as $year)
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ url('/inventaris/filter_file/' . $folder->slug . '?tahun=' . $year) }}">{{ $year }}</a>
                                            </li>
                                        @endforeach
                                ...
                                <li>
                                    ...
                                    <ul class="dropdown-menu dropdown-submenu dropdown-submenu-left">
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ url('/inventaris/filter_file/' . $folder->slug . '?file_type=image') }}">Image</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ url('/inventaris/filter_file/' . $folder->slug . '?file_type=pdf') }}">PDF</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ url('/inventaris/filter_file/' . $folder->slug . '?file_type=excel') }}">Excel</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ url('/inventaris/filter_file/' . $folder->slug . '?file_type=word') }}">Word</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ url('/inventaris/filter_file/' . $folder->slug . '?file_type=lain') }}">Lainnya</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                <li>
                                    ...
                                    <ul class="dropdown-menu dropdown-submenu dropdown-submenu-left">
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ url('/inventaris/sort_file/' . $folder->slug . '?name=asc') }}">Ascending</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ url('/inventaris/sort_file/' . $folder->slug . '?name=desc') }}">Descending</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul class="dropdown-menu dropdown-submenu dropdown-submenu-left">
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ url('/inventaris/sort_file/' . $folder->slug . '?tahun=asc') }}">Ascending</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ url('/inventaris/sort_file/' . $folder->slug . '?tahun=desc') }}">Descending</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        @if ($filter)
                            <div class="d-flex">
                                <h4>Filter {{ $filter }}</h4>
                                <a href="{{ url('/inventaris/' . $folder->slug) }}"
                                    ...
                                    <div class="action">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu  dropdown-menu-arrow">
                                                ...
                                                <a href="{{ route('inventaris.download_file', $file->id) }}"
                ...
                <div class="modal-body p-0">
                    <div class="card bg-secondary border-0 mb-0">
                        <div class="card-body px-lg-5 py-lg-5">
                            ...
                            <form role="form" method="POST" action="{{ url('inventaris/store_file/' . $folder->id) }}"
...
@section('js')
    ...
    <script>
        ...
        $(document).on('click', '.btn_delete', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/inventaris/destroy_file/" + id,
                        type: 'delete',
                        success: function(data) {
                            location.reload()
                            Swal.fire(
        ...
        $('#search_input').keyup(function() {
            ...
            $.ajax({
                url: "/inventaris/searching?slug=" + slug + "&file=" + value,
                success: function(data) {
                    $('.main-box').empty();
                                    ...
                                    <div class="action">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu  dropdown-menu-arrow">
                                                ...
                                                <a href="/inventaris/download_file/${element.id}"
