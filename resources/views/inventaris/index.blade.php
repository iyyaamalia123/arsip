                ...
                <div class="modal-body p-0">
                    <div class="card bg-secondary border-0 mb-0">
                        <div class="card-body px-lg-5 py-lg-5">
                            ...
                            <form role="form" method="POST" action="{{ url('inventaris/store_folder/' . $id_menu) }}">
                                @csrf
...
@section('js')
    <script>
        ...
        $(document).on('click', '.btn_rename', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#form_rename').attr('action', 'inventaris/rename_folder/' + id);
                }
            })
        })
        ...
        $(document).on('click', '.btn_delete', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/inventaris/destroy_folder/" + id,
                        type: 'delete',
                        success: function(data) {
                            location.reload()
                            Swal.fire(
        ...
        $('#search_input').keyup(function() {
            ...
            $.ajax({
                url: "/inventaris/searching?folder=" + value,
                success: function(data) {
                    $('.main-box').empty();
